...
public class ControllerProduto {
    ...
    */
    ...
    public ModelProduto getProdutoDescricaoController(String pProDescricao){
    return this.daoProduto.getProdutoDescricaoDAO(pProDescricao);
    }
    public boolean atualizarEstoqueController(ModelProduto pModelProduto){
    return this.daoProduto.atualizarEstoqueDAO(pModelProduto);
    }
}
